...
# PLEASE CHANGE: Specify location of TanNguyen2025_BA stable project directory
export TANNGUYEN2025_BA_DIR=$CBIG_CODE_DIR/stable_projects/predict_phenotypes/TanNguyen2025_BA
...
export MATLAB_RUNTIME_DIR=/apps/matlab/MATLAB_Compiler_Runtime/v95
